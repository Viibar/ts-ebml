  ...
  const tests = [
    {
      ...
      test: (elm: D) => {
        assert.ok(
          elm.name === "EBML" && elm.type === "m" && elm.isEnd === false
        );
      },
    },
    {
      ...
      test: (elm: D) => {
        assert.ok(
          elm.name === "EBML" && elm.type === "m" && elm.isEnd === true
        );
      },
    },
    {
      ...
      test: (elm: D) => {
        assert.ok(
          elm.name === "Segment" && elm.type === "m" && elm.isEnd === false
        );
      },
    },
    {
      ...
      test: (elm: D) => {
        assert.ok(
          elm.name === "Info" && elm.type === "m" && elm.isEnd === false
        );
      },
    },
    {
...
function waitEvent<E extends Event>(
  target: EventTarget,
  ev: string,
  err = "error"
): Promise<E> {
